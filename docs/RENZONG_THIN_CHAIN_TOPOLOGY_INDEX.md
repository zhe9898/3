...
1. office/yamen implementation drag, because court and frontier pressure must arrive through documents, clerks, and local bargaining rather than direct imperial commands;
2. public-life and map projection, because the player must see where pressure landed before issuing bounded commands;
3. household/family relief choice depth, after v36's sponsor-clan pressure handoff has enough readback to become a bounded command surface;
