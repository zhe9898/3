...
### Current household mobility runtime livelihood-trigger extraction: v789-v796
...
### Current population households runtime rule file split: v861-v868
...
### Current population households grain price pressure clamp extraction: v957-v964
...
### Current population households grain price jump band extraction: v973-v980

V973-V980 moves the grain-price jump threshold/score bands into owner-consumed `PopulationHouseholdMobilityRulesData` without changing social-strata behavior. These values only classify one private subsistence pressure component inside `PopulationAndHouseholds`; they are not a class/status engine, rank ladder, social mobility path, route-history store, or `PersonRegistry` expansion.

The extraction is default-equivalent. It does not create a status rank, class rail, grain-price-jump ledger, pressure-profile state, movement selector, route-history, migration economy, or UI-visible social position, and Application/UI/Unity still may not infer household movement, household pressure, or social status from config.

### Current population households grain price market tightness band extraction: v981-v988
...
### Current population households subsistence labor capacity extraction: v997-v1004
...
### Current population households subsistence labor clamp extraction: v1013-v1020
...
### Current population households subsistence fragility debt extraction: v1037-v1044
...
### Current population households subsistence interaction cash-need extraction: v1069-v1076
...
### Current population households subsistence interaction clamp extraction: v1093-v1100
...
### Current population households subsistence distress delta clamp extraction: v1109-v1116
...
### Current population households official supply distress delta clamp extraction: v1133-v1140

V1133-V1140 moves the official-supply distress delta clamp into owner-consumed `PopulationHouseholdMobilityRulesData` without changing social-strata behavior. The clamp remains a private household-owned supply burden bound, not a class/status ladder, route-history state, movement command, or `PersonRegistry` expansion.

The extraction is default-equivalent. It does not retune official-supply debt/labor/migration deltas, event threshold, signal fallback, tax-season formulas, or household mobility rules, and it does not create official-supply-delta state, a pressure-profile ledger, movement selector, route-history, migration economy, or UI-visible social position.

### Current population households official supply debt delta clamp extraction: v1141-v1148

V1141-V1148 moves the official-supply debt delta clamp into owner-consumed `PopulationHouseholdMobilityRulesData` without changing social-strata behavior. The clamp remains a private household-owned supply burden bound, not a class/status ladder, route-history state, movement command, or `PersonRegistry` expansion.

The extraction is default-equivalent. It does not retune official-supply distress/labor/migration deltas, event threshold, signal fallback, tax-season formulas, or household mobility rules, and it does not create official-supply-debt-delta state, a pressure-profile ledger, movement selector, route-history, migration economy, or UI-visible social position.

### Current population households official supply labor drop clamp extraction: v1149-v1156
...
### Current population households official supply burden event threshold extraction: v1165-v1172
...
### Current population households official supply livelihood exposure extraction: v1189-v1196
...
### Current population households official supply labor pressure extraction: v1205-v1212

V1205-V1212 moves official-supply labor capacity bands, dependent count bands, and dependent/labor ratio bonus into owner-consumed `PopulationHouseholdMobilityRulesData` without changing social-strata behavior. These values remain private household-owned burden pressure inputs, not route-history state, movement command, migration economy, class/status ladder, or `PersonRegistry` expansion.

The extraction is default-equivalent. It does not retune official-supply livelihood exposure, resource buffer, liquidity, fragility, interaction, delta formulas, event threshold, signal fallback, tax-season formulas, or household mobility rules, and it does not create official-supply-labor-pressure state, a pressure-profile ledger, movement selector, route-history, migration economy, or UI-visible social position.

### Current population households official supply liquidity pressure extraction: v1213-v1220
...
### Current population households official supply interaction pressure extraction: v1229-v1236

V1229-V1236 moves official-supply interaction livelihood conditions, thresholds, boost scores, resilience relief, fallback scores, and clamp into owner-consumed `PopulationHouseholdMobilityRulesData` without changing social-strata behavior. These values remain private household-owned interaction pressure inputs, not route-history state, movement command, migration economy, class/status ladder, or `PersonRegistry` expansion.

The extraction is default-equivalent. It does not retune official-supply livelihood exposure, resource buffer, labor pressure, liquidity pressure, fragility pressure, delta formulas, event threshold, tax-season formulas, household movement rules, or UI-visible social position.

### Current population households official supply distress delta formula extraction: v1237-v1244
...
### Current population households official supply labor drop formula extraction: v1253-v1260

V1253-V1260 moves official-supply labor drop formula divisors, labor-pressure floor, and component weight into owner-consumed `PopulationHouseholdMobilityRulesData` without changing social-strata behavior. These values remain private household-owned burden-profile inputs, not route-history state, movement command, migration economy, class/status ladder, or `PersonRegistry` expansion.

The extraction is default-equivalent. It does not retune official-supply livelihood exposure, resource buffer, labor pressure, liquidity pressure, fragility pressure, interaction pressure, distress/debt/migration deltas, event threshold, tax-season formulas, household movement rules, or UI-visible social position.

### Current population households official supply migration delta formula extraction: v1261-v1268

V1261-V1268 moves official-supply migration delta formula divisors and fragility threshold/boost into owner-consumed `PopulationHouseholdMobilityRulesData` without changing social-strata behavior. These values remain private household-owned burden-profile inputs, not route-history state, movement command, migration economy, class/status ladder, or `PersonRegistry` expansion.

The extraction is default-equivalent. It does not retune official-supply livelihood exposure, resource buffer, labor pressure, liquidity pressure, fragility pressure, interaction pressure, distress/debt/labor deltas, event threshold, tax-season formulas, household movement rules, or UI-visible social position.

### Current population households tax season registration visibility extraction: v1269-v1276
...
### Current population households tax season labor pressure extraction: v1285-v1292
...
### Current population households tax season interaction pressure extraction: v1301-v1308

V1301-V1308 moves tax-season interaction tenant pressure, land/labor pressure, cash-need livelihood pressure, resilience relief, fallback scores, and clamp into owner-consumed `PopulationHouseholdMobilityRulesData` without changing social-strata behavior. These values remain private household-owned tax burden inputs, not route-history state, movement command, migration economy, class/status ladder, or `PersonRegistry` expansion.

The extraction is default-equivalent. It does not retune tax-season registration visibility, liquidity, labor, fragility, debt-delta formula, event threshold, official-supply rules, household movement rules, or UI-visible social position.

### Current population households tax season debt delta formula extraction: v1309-v1316
