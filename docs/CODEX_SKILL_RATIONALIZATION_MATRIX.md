...
- Public-life/order closure is implemented through v52 on the current mainline: v3-v30 close Order / home-household / owner-lane projection readback; v31 is merge/branch-cleanup evidence; v32-v34 harden event-contract diagnostics; v35 links canal-window pressure to Trade/Order owner lanes; v36 links household burden to Family sponsor pressure; v37-v45 add Office/yamen implementation and readback; v46-v52 close Office owner-lane entry / receipt / residue / no-loop guidance.
...
| --- | --- | --- | --- | --- | --- |
| `zongzu-architecture-boundaries` | Module ownership, scheduler flow, command/query/event seams, save/version contracts, extension boundaries, hot-path ownership. | `ModuleRunner<TState>`, `MonthlyScheduler`, `GameSimulation`, module `PublishedEvents` / `ConsumedEvents`, boundary docs, projection contexts, v32-v52 event-contract, canal-window, household-family, Office/yamen, and Office-lane closure evidence. | .NET modular testability, explicit dependency discipline, measured hot-path optimization, low-allocation diagnostics. | Add a giant world manager, Application second rule layer, runtime plugin marketplace, foreign state mutation, UI/Unity rule path, or global cache that changes determinism. | Architecture/integration tests, event-contract tests, v35 Trade/Order canal-window consumer tests, v36 FamilyCore household-burden consumer tests, v37-v52 Office implementation/readback tests, `git diff --check`, focused compile/test lane, counter/profiler evidence when performance behavior changes. |
| `zongzu-game-design` | Living-world loop, bounded player leverage, monthly review, actor autonomy, MVP/post-MVP shape, fidelity/scale budget. | `PRODUCT_SCOPE.md`, `SIMULATION.md`, `SIMULATION_FIDELITY_MODEL.md`, `PLAYER_SCOPE.md`, implementation of command receipts/projections, v35-v52 thin handoff/readback passes, and current no-ledger/no-schema discipline. | Game-system proposal discipline: owner, cadence, state, event, projection, player response, tests, cardinality/fanout budget. | Build an event-pool game, fixed route tree, player-as-god interface, detached tactics layer, full-map high-fidelity simulation by default, or treat every future contract as immediate gameplay. | Acceptance tests, command-resolution tests, projection/receipt tests, no-touch tests, long-run diagnostics when balance or scale changes. |
| `zongzu-pressure-chain` | Cross-module pressure propagation, especially Renzong thin/full chains, public-life/order/social-memory closure, and owner-lane handoffs. | `RENZONG_THIN_CHAIN_TOPOLOGY_INDEX.md`, module event metadata, scheduler drain, off-scope tests, public-life/order v3-v52 evidence, v32-v34 event-contract diagnostics, v35 canal-window Trade/Order handoff, v36 household-family handoff, v37-v52 Office/yamen and Office-lane closure readback. | Traceable cause-effect design, minimal focused tests, explicit fanout/allocation proof. | Call a chain complete from docs alone, parse summaries as authority, fan out global pressure without locus/allocation, describe refusal/response residue as an event-pool design, or mistake diagnostic classification for runtime propagation. | Integration tests proving propagation, no-touch entities, metadata, projection receipts, SocialMemory-owned residue when in scope, classified event debt, owner/evidence backlinks, sponsor-clan no-touch proof, Office implementation/closure proof, and bounded chain complexity. |
...
## Skill Alignment Through V52 - 2026-04-26

- The local Codex skill pack and repo-tracked `.github/skills` pack should carry the same v52 anchors: v31 merge cleanup, v32-v34 event-contract diagnostics, v35 canal-window Trade/Order handoff, v36 household-burden Family handoff, v37-v45 Office/yamen implementation/readback, and v46-v52 Office-lane closure.
