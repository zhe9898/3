...
## PopulationAndHouseholds monthly pulse file split v917-v924 acceptance - 2026-05-03
...
## PopulationAndHouseholds grain price pressure clamp extraction v957-v964 acceptance - 2026-05-03
...
## PopulationAndHouseholds grain price jump band extraction v973-v980 acceptance - 2026-05-03
...
## PopulationAndHouseholds subsistence dependent count extraction v1005-v1012 acceptance - 2026-05-03

Acceptance evidence for V1005-V1012:
- Population tests `GrainPriceSpike_DefaultDependentCountRulesDataMatchesPreviousBaseline` and `GrainPriceSpike_InvalidDependentCountRulesDataFallsBackToPreviousBaseline` prove extracted defaults preserve prior dependent-count behavior and malformed config falls back deterministically.
...
## PopulationAndHouseholds subsistence grain buffer extraction v1021-v1028 acceptance - 2026-05-03

Acceptance evidence for V1021-V1028:
- Population tests `GrainPriceSpike_DefaultGrainBufferRulesDataMatchesPreviousBaseline`, `GrainPriceSpike_CustomGrainBufferRulesDataIsOwnerConsumed`, and `GrainPriceSpike_InvalidGrainBufferRulesDataFallsBackToPreviousBaseline` prove extracted defaults preserve prior grain-buffer behavior, owner custom bands are consumed deterministically, and malformed config falls back deterministically.
...
## PopulationAndHouseholds subsistence fragility debt extraction v1037-v1044 acceptance - 2026-05-03

Acceptance evidence for V1037-V1044:
- Population tests `GrainPriceSpike_DefaultFragilityDebtRulesDataMatchesPreviousBaseline`, `GrainPriceSpike_CustomFragilityDebtRulesDataIsOwnerConsumed`, and `GrainPriceSpike_InvalidFragilityDebtRulesDataFallsBackToPreviousBaseline` prove extracted defaults preserve prior debt fragility behavior, owner custom bands are consumed deterministically, and malformed config falls back deterministically.
...
## PopulationAndHouseholds subsistence fragility clamp extraction v1053-v1060 acceptance - 2026-05-03

Acceptance evidence for V1053-V1060:
- Population tests `GrainPriceSpike_DefaultFragilityClampRulesDataMatchesPreviousBaseline`, `GrainPriceSpike_CustomFragilityClampRulesDataIsOwnerConsumed`, and `GrainPriceSpike_InvalidFragilityClampRulesDataFallsBackToPreviousBaseline` prove extracted defaults preserve prior fragility clamp behavior, owner custom clamp is consumed deterministically, and malformed config falls back deterministically.
- Architecture guard `Population_households_subsistence_fragility_clamp_extraction_v1053_v1060_must_remain_owner_consumed_and_schema_neutral` proves fragility clamp floor/ceiling moved into owner-consumed rules-data without schema drift, expanding `PersonRegistry`, adding loader/plugin authority, parsing prose, or giving Application/UI/Unity outcome authority.

Schema/migration impact: none. This pass does not extract interaction, tax-season, or official-supply formulas.

## PopulationAndHouseholds subsistence interaction grain shortage extraction v1061-v1068 acceptance - 2026-05-03

Acceptance evidence for V1061-V1068:
- Population tests `GrainPriceSpike_DefaultInteractionGrainShortageRulesDataMatchesPreviousBaseline`, `GrainPriceSpike_CustomInteractionGrainShortageRulesDataIsOwnerConsumed`, and `GrainPriceSpike_InvalidInteractionGrainShortageRulesDataFallsBackToPreviousBaseline` prove extracted defaults preserve prior interaction grain-shortage window behavior, owner custom window is consumed deterministically, and malformed config falls back deterministically.
...
## PopulationAndHouseholds subsistence interaction debt-boost extraction v1077-v1084 acceptance - 2026-05-03

Acceptance evidence for V1077-V1084:
- Population tests `GrainPriceSpike_DefaultInteractionDebtPressureRulesDataMatchesPreviousBaseline`, `GrainPriceSpike_CustomInteractionDebtPressureThresholdRulesDataIsOwnerConsumed`, `GrainPriceSpike_CustomInteractionDebtPressureBoostRulesDataIsOwnerConsumed`, and `GrainPriceSpike_InvalidInteractionDebtPressureRulesDataFallsBackToPreviousBaseline` prove extracted defaults preserve prior interaction debt boost behavior, owner custom threshold/boost are consumed deterministically, and malformed config falls back deterministically.
- Architecture guard `Population_households_subsistence_interaction_debt_boost_extraction_v1077_v1084_must_remain_owner_consumed_and_schema_neutral` proves interaction debt threshold/boost moved into owner-consumed rules-data without schema drift, expanding `PersonRegistry`, adding loader/plugin authority, parsing prose, or giving Application/UI/Unity outcome authority.

Schema/migration impact: none. This pass does not extract resilience relief, interaction clamp, tax-season, or official-supply formulas.

## PopulationAndHouseholds subsistence interaction resilience relief extraction v1085-v1092 acceptance - 2026-05-03

Acceptance evidence for V1085-V1092:
- Population tests `GrainPriceSpike_DefaultInteractionResilienceReliefRulesDataMatchesPreviousBaseline`, `GrainPriceSpike_CustomInteractionResilienceThresholdRulesDataIsOwnerConsumed`, `GrainPriceSpike_CustomInteractionResilienceReliefScoreRulesDataIsOwnerConsumed`, and `GrainPriceSpike_InvalidInteractionResilienceReliefRulesDataFallsBackToPreviousBaseline` prove extracted defaults preserve prior interaction resilience relief behavior, owner custom thresholds/relief score are consumed deterministically, and malformed config falls back deterministically.
...
## PopulationAndHouseholds subsistence distress delta clamp extraction v1109-v1116 acceptance - 2026-05-03

Acceptance evidence for V1109-V1116:
- Population tests `GrainPriceSpike_DefaultSubsistenceDistressDeltaClampRulesDataMatchesPreviousBaseline`, `GrainPriceSpike_CustomSubsistenceDistressDeltaClampFloorRulesDataIsOwnerConsumed`, `GrainPriceSpike_CustomSubsistenceDistressDeltaClampCeilingRulesDataIsOwnerConsumed`, and `GrainPriceSpike_InvalidSubsistenceDistressDeltaClampRulesDataFallsBackToPreviousBaseline` prove extracted defaults preserve prior distress delta clamp behavior, owner custom floor/ceiling are consumed deterministically, and malformed config falls back deterministically.
- Architecture guard `Population_households_subsistence_distress_delta_clamp_extraction_v1109_v1116_must_remain_owner_consumed_and_schema_neutral` proves the distress delta clamp moved into owner-consumed rules-data without schema drift, expanding `PersonRegistry`, adding loader/plugin authority, parsing prose, or giving Application/UI/Unity outcome authority.

Schema/migration impact: none. This pass does not extract tax-season or official-supply formulas.

## PopulationAndHouseholds tax season debt delta clamp extraction v1117-v1124 acceptance - 2026-05-03

Acceptance evidence for V1117-V1124:
- Population tests `TaxSeasonOpened_DefaultTaxDebtDeltaClampRulesDataMatchesPreviousBaseline`, `TaxSeasonOpened_CustomTaxDebtDeltaClampFloorRulesDataIsOwnerConsumed`, `TaxSeasonOpened_CustomTaxDebtDeltaClampCeilingRulesDataIsOwnerConsumed`, and `TaxSeasonOpened_InvalidTaxDebtDeltaClampRulesDataFallsBackToPreviousBaseline` prove extracted defaults preserve prior tax debt delta clamp behavior, owner custom floor/ceiling are consumed deterministically, and malformed config falls back deterministically.
...
## PopulationAndHouseholds official supply debt delta clamp extraction v1141-v1148 acceptance - 2026-05-04

Acceptance evidence for V1141-V1148:
- Population tests `OfficialSupplyRequisition_DefaultDebtDeltaClampRulesDataMatchesPreviousBaseline`, `OfficialSupplyRequisition_CustomDebtDeltaClampFloorRulesDataIsOwnerConsumed`, `OfficialSupplyRequisition_CustomDebtDeltaClampCeilingRulesDataIsOwnerConsumed`, and `OfficialSupplyRequisition_InvalidDebtDeltaClampRulesDataFallsBackToPreviousBaseline` prove extracted defaults preserve prior official-supply debt delta clamp behavior, owner custom floor/ceiling are consumed deterministically, and malformed config falls back deterministically.
- Architecture guard `Population_households_official_supply_debt_delta_clamp_extraction_v1141_v1148_must_remain_owner_consumed_and_schema_neutral` proves the official-supply debt delta clamp moved into owner-consumed rules-data without schema drift, expanding `PersonRegistry`, adding loader/plugin authority, parsing prose, or giving Application/UI/Unity outcome authority.

## PopulationAndHouseholds official supply labor drop clamp extraction v1149-v1156 acceptance - 2026-05-04

Acceptance evidence for V1149-V1156:
- Population tests `OfficialSupplyRequisition_DefaultLaborDropClampRulesDataMatchesPreviousBaseline`, `OfficialSupplyRequisition_CustomLaborDropClampFloorRulesDataIsOwnerConsumed`, `OfficialSupplyRequisition_CustomLaborDropClampCeilingRulesDataIsOwnerConsumed`, and `OfficialSupplyRequisition_InvalidLaborDropClampRulesDataFallsBackToPreviousBaseline` prove extracted defaults preserve prior official-supply labor drop clamp behavior, owner custom floor/ceiling are consumed deterministically, and malformed config falls back deterministically.
- Architecture guard `Population_households_official_supply_labor_drop_clamp_extraction_v1149_v1156_must_remain_owner_consumed_and_schema_neutral` proves the official-supply labor drop clamp moved into owner-consumed rules-data without schema drift, expanding `PersonRegistry`, adding loader/plugin authority, parsing prose, or giving Application/UI/Unity outcome authority.

## PopulationAndHouseholds official supply migration delta clamp extraction v1157-v1164 acceptance - 2026-05-04

Acceptance evidence for V1157-V1164:
- Population tests `OfficialSupplyRequisition_DefaultMigrationDeltaClampRulesDataMatchesPreviousBaseline`, `OfficialSupplyRequisition_CustomMigrationDeltaClampFloorRulesDataIsOwnerConsumed`, `OfficialSupplyRequisition_CustomMigrationDeltaClampCeilingRulesDataIsOwnerConsumed`, and `OfficialSupplyRequisition_InvalidMigrationDeltaClampRulesDataFallsBackToPreviousBaseline` prove extracted defaults preserve prior official-supply migration delta clamp behavior, owner custom floor/ceiling are consumed deterministically, and malformed config falls back deterministically.
...
### PopulationAndHouseholds official supply fragility pressure extraction v1221-v1228 acceptance

Acceptance requires default-equivalent behavior for official-supply fragility distress bands, debt bands, migration-risk threshold, shelter-drag threshold, fallback scores, and clamp, deterministic fallback for malformed fragility pressure rules-data, owner-only consumption by `PopulationAndHouseholds`, no save/schema drift, no rules-data loader/plugin system, no `PersonRegistry` expansion, no prose parsing, and no Application/UI/Unity authority.
