...
V909-V916 changes file layout only. Monthly livelihood drift helpers stay inside the same `PopulationAndHouseholds` owner lane, `RunMonth` keeps the same household traversal, and near-detail/far-summary fidelity behavior is unchanged.
...
V957-V964 changes parameter ownership only. Grain-price price-pressure clamp bounds are validated and consumed by `PopulationAndHouseholds`, while grain-price event scope, deterministic household ordering, price level/jump/tightness bands, subsistence pressure formulas, focus-ring detail, active-pool logic, and near-detail/far-summary fidelity behavior remain unchanged.

No new household target store, movement ledger, route-history model, selector watermark, grain-price-pressure state, pressure-profile state, class/status state, `PersonRegistry` state, or distant-society detail promotion is added.

## V965-V972 PopulationAndHouseholds Grain Price Level Band Extraction

V965-V972 changes parameter ownership only. Grain-price level threshold/score bands are validated and consumed by `PopulationAndHouseholds`, while grain-price event scope, deterministic household ordering, price jump bands, market tightness bands, subsistence pressure formulas, focus-ring detail, active-pool logic, and near-detail/far-summary fidelity behavior remain unchanged.

No new household target store, movement ledger, route-history model, selector watermark, grain-price-level state, pressure-profile state, class/status state, `PersonRegistry` state, or distant-society detail promotion is added.

## V973-V980 PopulationAndHouseholds Grain Price Jump Band Extraction

V973-V980 changes parameter ownership only. Grain-price jump threshold/score bands are validated and consumed by `PopulationAndHouseholds`, while grain-price event scope, deterministic household ordering, market tightness bands, subsistence pressure formulas, focus-ring detail, active-pool logic, and near-detail/far-summary fidelity behavior remain unchanged.
...
V989-V996 changes parameter ownership only. Subsistence market dependency livelihood-score weights are validated and consumed by `PopulationAndHouseholds`, while grain-price event scope, deterministic household ordering, labor/fragility/interaction formulas, tax-season pressure, official-supply pressure, focus-ring detail, active-pool logic, and near-detail/far-summary fidelity behavior remain unchanged.
...
V1029-V1036 changes parameter ownership only. Subsistence fragility distress bands are validated and consumed by `PopulationAndHouseholds`, while grain-price event scope, deterministic household ordering, debt/migration/fragility-clamp formulas, interaction formulas, tax-season pressure, official-supply pressure, focus-ring detail, active-pool logic, and near-detail/far-summary fidelity behavior remain unchanged.

No new household target store, movement ledger, route-history model, selector watermark, fragility-distress state, pressure-profile state, class/status state, `PersonRegistry` state, or distant-society detail promotion is added.
...
V1053-V1060 changes parameter ownership only. The subsistence fragility final clamp floor and ceiling are validated and consumed by `PopulationAndHouseholds`, while grain-price event scope, deterministic household ordering, distress/debt/migration formulas, interaction formulas, tax-season pressure, official-supply pressure, focus-ring detail, active-pool logic, and near-detail/far-summary fidelity behavior remain unchanged.

No new household target store, movement ledger, route-history model, selector watermark, fragility-clamp state, pressure-profile state, class/status state, `PersonRegistry` state, or distant-society detail promotion is added.
...
V1253-V1260 changes parameter ownership only. The official-supply labor drop formula divisors, labor-pressure floor, and component weight are validated and consumed by `PopulationAndHouseholds`, while official-supply component pressure scoring, distress/debt/migration deltas, event threshold, deterministic household ordering, focus-ring detail, active-pool logic, and near-detail/far-summary fidelity behavior remain unchanged.
...
V1157-V1164 changes parameter ownership only. The official-supply migration delta clamp floor/ceiling are validated and consumed by `PopulationAndHouseholds`, while official-supply distress/debt/labor deltas, event threshold, signal fallback, deterministic household ordering, focus-ring detail, active-pool logic, and near-detail/far-summary fidelity behavior remain unchanged.

No new household target store, movement ledger, route-history model, selector watermark, official-supply-migration-delta state, pressure-profile state, class/status state, `PersonRegistry` state, or distant-society detail promotion is added.

## V1165-V1172 PopulationAndHouseholds Official Supply Burden Event Threshold Extraction

V1165-V1172 changes parameter ownership only. The official-supply burden event distress threshold is validated and consumed by `PopulationAndHouseholds`, while official-supply distress/debt/labor/migration deltas, signal fallback, deterministic household ordering, focus-ring detail, active-pool logic, and near-detail/far-summary fidelity behavior remain unchanged.

No new household target store, movement ledger, route-history model, selector watermark, official-supply-event-threshold state, pressure-profile state, class/status state, `PersonRegistry` state, or distant-society detail promotion is added.
...
## V1213-V1220 PopulationAndHouseholds Official Supply Liquidity Pressure Extraction

V1213-V1220 changes parameter ownership only. The official-supply liquidity grain strain bands, cash-need score, tool drag threshold, debt drag bands, fallback values, and clamp are validated and consumed by `PopulationAndHouseholds`, while official-supply livelihood exposure, resource buffer, labor pressure, fragility/interaction helpers, distress/debt/labor/migration deltas, event threshold, deterministic household ordering, focus-ring detail, active-pool logic, and near-detail/far-summary fidelity behavior remain unchanged.

No new household target store, movement ledger, route-history model, selector watermark, official-supply-liquidity-pressure state, pressure-profile state, class/status state, `PersonRegistry` state, or distant-society detail promotion is added.
...
V1277-V1284 changes parameter ownership only. The tax-season liquidity grain pressure bands, cash-need livelihood scores, tool-drag threshold/score, fallback values, and clamp are validated and consumed by `PopulationAndHouseholds`, while tax-season registration visibility, labor/fragility/interaction scoring, debt delta formula, event threshold, deterministic household ordering, focus-ring detail, active-pool logic, and near-detail/far-summary fidelity behavior remain unchanged.

No new household target store, movement ledger, route-history model, selector watermark, tax-season-liquidity-pressure state, pressure-profile state, class/status state, `PersonRegistry` state, or distant-society detail promotion is added.

## V1285-V1292 PopulationAndHouseholds Tax Season Labor Pressure Extraction

V1285-V1292 changes parameter ownership only. The tax-season labor capacity bands, dependent count bands, dependent/labor ratio bonus, fallback values, and clamp are validated and consumed by `PopulationAndHouseholds`, while tax-season registration visibility, liquidity, fragility/interaction scoring, debt delta formula, event threshold, deterministic household ordering, focus-ring detail, active-pool logic, and near-detail/far-summary fidelity behavior remain unchanged.

No new household target store, movement ledger, route-history model, selector watermark, tax-season-labor-pressure state, pressure-profile state, class/status state, `PersonRegistry` state, or distant-society detail promotion is added.
