...
public sealed class FirstPassPresentationShellTests
{
	...
	public void Compose_ProjectsPublicLifeAffordancesAndReceiptsIntoSettlementNodes()
	{
		...
		{
			Affordances = new global::<>z__ReadOnlySingleElementList<PlayerCommandAffordanceSnapshot>(new PlayerCommandAffordanceSnapshot
			{
			...
			Receipts = new global::<>z__ReadOnlySingleElementList<PlayerCommandReceiptSnapshot>(new PlayerCommandReceiptSnapshot
			{
				ModuleKey = "OfficeAndCareer",
				SurfaceKey = "PublicLife",
				SettlementId = new SettlementId(1),
		...
		presentationReadModelBundle.PublicLifeSettlements = new global::<>z__ReadOnlySingleElementList<SettlementPublicLifeSnapshot>(new SettlementPublicLifeSnapshot
		{
			SettlementId = new SettlementId(1),
			SettlementName = "兰溪",
	...
	{
		PresentationReadModelBundle presentationReadModelBundle = CreateBundle();
		presentationReadModelBundle.GovernanceSettlements = new global::<>z__ReadOnlySingleElementList<SettlementGovernanceLaneSnapshot>(new SettlementGovernanceLaneSnapshot
		{
			SettlementId = new SettlementId(1),
	...
	{
		PresentationReadModelBundle presentationReadModelBundle = CreateBundle();
		presentationReadModelBundle.Notifications = new global::<>z__ReadOnlySingleElementList<NarrativeNotificationSnapshot>(new NarrativeNotificationSnapshot
		{
	...
	public void Compose_ProjectsSecondaryHallDocketItemsIntoGreatHall()
	{
		...
		presentationReadModelBundle.HallDocket = new HallDocketStackSnapshot
		{
			...
			SecondaryItems = new global::<>z__ReadOnlyArray<HallDocketItemSnapshot>(new HallDocketItemSnapshot[2]
			{
	...
	public void Compose_LeavesDeskLeadHallAgendaMarkerEmptyWhenLeadItemTargetsElsewhere()
	{
		...
		presentationReadModelBundle.HallDocket = new HallDocketStackSnapshot
		{
			...
			SecondaryItems = new global::<>z__ReadOnlySingleElementList<HallDocketItemSnapshot>(new HallDocketItemSnapshot
			{
				LaneKey = "Governance",
				SettlementId = new SettlementId(1),
				SettlementName = "Lanxi",
	...
	public void Compose_AlignsFamilyLifecycleLeadNoticeAndNotificationCenterGuidance()
	{
		...
		presentationReadModelBundle.Notifications = new global::<>z__ReadOnlySingleElementList<NarrativeNotificationSnapshot>(new NarrativeNotificationSnapshot
		{
			...
			Traces = new global::<>z__ReadOnlySingleElementList<NotificationTraceSnapshot>(new NotificationTraceSnapshot
			{
				SourceModuleKey = "FamilyCore",
	...
	public void Compose_ProjectsRegionalWarfareAndAftermathIntoHallDeskAndCampaignBoard_V4()
	{
		...
		presentationReadModelBundle.TradeRoutes = new global::<>z__ReadOnlySingleElementList<TradeRouteSnapshot>(new TradeRouteSnapshot
		{
			RouteId = 1,
			ClanId = new ClanId(1),
			SettlementId = new SettlementId(1),
		...
		presentationReadModelBundle.Campaigns = new global::<>z__ReadOnlySingleElementList<CampaignFrontSnapshot>(new CampaignFrontSnapshot
		{
			...
			Routes = new global::<>z__ReadOnlyArray<CampaignRouteSnapshot>(new CampaignRouteSnapshot[2]
			{
	...
	private static PresentationReadModelBundle CreateBundle()
	{
		...
		presentationReadModelBundle.Clans = new global::<>z__ReadOnlySingleElementList<ClanSnapshot>(new ClanSnapshot
		{
			Id = new ClanId(1),
			ClanName = "清河张氏",
		...
		presentationReadModelBundle.ClanNarratives = new global::<>z__ReadOnlySingleElementList<ClanNarrativeSnapshot>(new ClanNarrativeSnapshot
		{
			ClanId = new ClanId(1),
		...
		presentationReadModelBundle.Settlements = new global::<>z__ReadOnlySingleElementList<SettlementSnapshot>(new SettlementSnapshot
		{
		...
		presentationReadModelBundle.PopulationSettlements = new global::<>z__ReadOnlySingleElementList<PopulationSettlementSnapshot>(new PopulationSettlementSnapshot
		{
			SettlementId = new SettlementId(1),
			CommonerDistress = 35,
			LaborSupply = 112,
		...
		presentationReadModelBundle.ClanTrades = new global::<>z__ReadOnlySingleElementList<ClanTradeSnapshot>(new ClanTradeSnapshot
		{
			ClanId = new ClanId(1),
		...
		presentationReadModelBundle.OfficeCareers = new global::<>z__ReadOnlySingleElementList<OfficeCareerSnapshot>(new OfficeCareerSnapshot
		{
		...
		presentationReadModelBundle.OfficeJurisdictions = new global::<>z__ReadOnlySingleElementList<JurisdictionAuthoritySnapshot>(new JurisdictionAuthoritySnapshot
		{
			SettlementId = new SettlementId(1),
		...
		presentationReadModelBundle.PlayerCommands = new PlayerCommandSurfaceSnapshot
		{
			Affordances = new global::<>z__ReadOnlyArray<PlayerCommandAffordanceSnapshot>(new PlayerCommandAffordanceSnapshot[2]
			{
