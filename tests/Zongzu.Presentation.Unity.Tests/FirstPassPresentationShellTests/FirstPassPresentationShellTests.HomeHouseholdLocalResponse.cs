            ...
            PlayerCommands = new PlayerCommandSurfaceSnapshot
            {
                ...
                [
                    new PlayerCommandAffordanceSnapshot
                    {
                        ...
                        LeverageSummary = "本户只动自家夜行、脚程与临时避险。 取舍预判：预期收益：先压夜路、渡口与迁徙险。 外部后账：不补巡丁、不催县门。",
                        CostSummary = "代价：丁力会被收紧。 承受线代价：会吃丁力，若旧账再硬，容易转成吃紧后账。 反噬尾巴：会挤丁力。",
                        ReadbackSummary = "下月看迁徙之念、丁力和后账。 承受线读回：看夜路是否缓住迁徙之念，以及丁力是否被压过线。 取舍读回：看迁徙之念是否下降。 外部后账：不补巡丁、不催县门。 社会记忆读回：人情23，本户后账已缓。",
                        TargetLabel = "张家户",
                        IsEnabled = true,
                    },
                ],
