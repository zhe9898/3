...
- current v19-v492 follow-up, owner-lane, Office/Family/Force/Warfare/Court readback, directive/aftermath docket readback, court-policy local-response/SocialMemory/public-reading/public-follow-up/docket/suggested-action/suggested-receipt/receipt-docket/public-life-receipt echo guard, social mobility / fidelity-ring / influence readbacks, regime-legitimacy readback, personnel-flow readiness/gate/future-lane preflight guards, commoner/social-position readback, source-key readback, scale-budget summaries, household mobility dynamics explanation, v461-v468 closeout governance, v469-v476 household mobility owner-lane preflight, v485-v492 preflight closeout governance, and closeout/preflight validation should prove projection-only derivation where claimed, owner-module mutation where claimed, no SocialMemory prose parsing, no receipt or `DomainEvent.Summary` parsing, no schema bump, no command outcome calculation in Application/UI/Unity, no follow-up/owner-lane/Office/Family/Force/Warfare/Court/policy/cooldown/docket/suggested-action/receipt/receipt-docket/public-life-receipt/social-mobility/regime/personnel/future-lane/status/household-mobility/route-history/preflight-closeout ledger, and focused integration/presentation assertions before any full-solution test
...
- current v109-v492 validation splits by branch: v109-v204 is narrow Chain 8 court-policy rule-density proof over structured Office/PublicLife/SocialMemory snapshots; v213-v292 is social mobility / fidelity-ring / influence proof over existing PopulationAndHouseholds and PersonRegistry snapshots; v253-v268 is regime-legitimacy readback proof over existing world/office/public-life snapshots; v293-v380 is personnel-flow readiness/gate/future-lane preflight proof that blocks direct move/transfer/summon/assign pressure while keeping future Family/Office/Warfare lanes as separately planned owner lanes; v381-v452 is social-position/source-key/scale-budget/fidelity preflight proof that blocks hidden class engines, global person scans, schema drift, and `PersonRegistry` expansion; v453-v460 is household mobility dynamics explanation proof over existing household pressure signals; v461-v468 is closeout proof that the explanation did not become movement, status, route-history, durable-residue, or schema authority; v469-v476 is owner-lane preflight proof that future household mobility depth must declare owner/cadence/scope/fanout/no-touch/schema/projection/validation before implementation; v485-v492 is closeout proof that the preflight itself did not become movement authority. Each branch must prove off-scope non-inheritance, schema neutrality, no summary/prose parsing, and Unity/ViewModel copy-only behavior when presentation is touched
- validation ladder for runtime depth: focused owner test first, then cross-module no-touch proof, deterministic replay or hash proof when cadence changes, full solution test, and only then long-run or counter/profiler evidence if scale/performance is claimed
- for scheduler/topology changes, record event count, touched owners, drain depth, cap behavior, repeated-pressure behavior, and failure mode rather than only asserting a final readback string
...
- Do not validate social-position or fidelity-scale work by eyeballing text only; prove source modules, regional/fidelity guard behavior, no global person scan, no schema drift, and copy-only ViewModel behavior when those surfaces are touched.
