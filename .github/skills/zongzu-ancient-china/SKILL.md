...
- current v35-v492 language should be treated as historically plausible pressure-carrier wording, not universal formula proof: canal-window friction can carry trade/order pressure, household burden can carry sponsor-clan pressure, Office/yamen后手 can carry document/clerk delay readback, force/campaign wording can carry mobilization and aftermath pressure, court-policy wording can carry court-to-local process, old public reading, docket/receipt anti-misread, and remembered county-document residue, regime wording can carry mandate/defection/public-legitimacy pressure, social-mobility wording can carry focus-ring/detail/pool abstraction, personnel-flow gate/future-lane wording can name lineage/office/campaign pathways, social-position / zhuhu-kehu / commoner-status wording can carry household registration, livelihood, service, office, memory, and local visibility, v453-v460 household mobility explanation can name debt/labor/migration dimensions, v461-v468 closeout keeps that explanation from becoming a universal migration economy or every-person simulation, v469-v476 preflight requires a future owner-lane rule before household movement or route history becomes authority, and v485-v492 closes that preflight without implementing movement authority
- v381-v452 social-position readbacks are historical/social interpretation surfaces over structured owner-module snapshots; they are not a fixed class engine, a universal status ladder, or proof that `PersonRegistry` owns social rank
...
- source calibration should produce plausible ranges, institutional carriers, regional variation, and uncertainty notes; it should not hard-code one universal Song formula into every county, household, or social position
- when designing mobility/status/court/regime depth, separate historical label, simulated owner state, projection wording, and player affordance so flavor never becomes hidden authority
