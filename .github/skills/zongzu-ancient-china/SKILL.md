...
- current v35-v380 language should be treated as historically plausible pressure-carrier wording, not universal formula proof: canal-window friction can carry trade/order pressure, household burden can carry sponsor-clan pressure, Office/yamen后手 can carry document/clerk delay readback, force/campaign wording can carry mobilization and aftermath pressure, court-policy wording can carry court-to-local process, old public reading, docket/receipt anti-misread, and remembered county-document residue, regime wording can carry mandate/defection/public-legitimacy pressure, social-mobility wording can carry focus-ring/detail/pool abstraction, and personnel-flow gate/future-lane wording can name lineage/office/campaign pathways without making every Song county or person fully simulated
