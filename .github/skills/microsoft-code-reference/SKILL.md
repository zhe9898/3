...
- The current mainline is through v380: v109-v204 closes the first Chain 8 court-policy rule-density branch; v213-v292 implements and closes the first social mobility / fidelity-ring substrate and readback layer; v253-v268 closes Chain 9 regime-legitimacy first readback; v293-v324 closes the first personnel-flow command-readiness layer; v325-v356 closes personnel-flow owner-lane gate / desk echo / containment; v357-v380 closes future Family/Office/Warfare personnel-flow lane preflight visibility without opening those lanes.
- v35-v380 use existing owner state or runtime projection fields for Trade/Order, Family, Office, PublicLife, SocialMemory, Force/Campaign, Warfare, Court-policy, social mobility, regime readback, personnel-flow readiness/gate/future-lane preflight evidence.
- v101-v108, v197-v204, v245-v252, v261-v268, v285-v292, v293-v300, v317-v324, v349-v356, and v373-v380 are documentation plus architecture-test closeout/preflight evidence. v213-v244 uses existing `PopulationAndHouseholds` and `PersonRegistry.FidelityRing` state only; v277-v284 adds runtime read-model/ViewModel fields only; v301-v316, v325-v348, and v357-v372 add runtime projection/ViewModel readback only. These passes add no schema bump, migration, ledger, manager/controller layer, UI/Unity authority, or `PersonRegistry` domain expansion.
