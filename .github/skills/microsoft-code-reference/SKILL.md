...
- The current mainline is through v492: v109-v204 closes the first Chain 8 court-policy rule-density branch; v213-v292 implements and closes the first social mobility / fidelity-ring substrate and readback layer; v253-v268 closes Chain 9 regime-legitimacy first readback; v293-v380 closes personnel-flow readiness/gate/future-lane preflight without opening direct movement lanes; v381-v452 closes commoner/social-position readback, owner-source keys, scale-budget readback, regional guard, and fidelity scale-budget preflight; v453-v460 adds household mobility dynamics explanation over existing signals; v461-v468 closes that layer as docs/tests governance only; v469-v476 adds household mobility owner-lane preflight; v485-v492 closes that preflight as governance only.
- v35-v492 use existing owner state, runtime projection fields, or docs/tests preflight evidence for Trade/Order, Family, Office, PublicLife, SocialMemory, Force/Campaign, Warfare, Court-policy, social mobility, regime readback, personnel-flow readiness/gate/future-lane preflight, commoner/social-position readback/source keys, fidelity scale-budget evidence, and household mobility dynamics explanation/closeout/preflight/closeout.
- v101-v108, v197-v204, v245-v252, v261-v268, v285-v292, v293-v300, v317-v324, v349-v356, v373-v380, v405-v412, v429-v436, v437-v444, v445-v452, v461-v468, v469-v476, and v485-v492 are documentation plus architecture-test closeout/preflight evidence. v213-v244 uses existing `PopulationAndHouseholds` and `PersonRegistry.FidelityRing` state only; v277-v284, v389-v404, v413-v428, and v453-v460 add runtime read-model/ViewModel fields only; v301-v316, v325-v348, and v357-v372 add runtime projection/ViewModel readback only. These passes add no schema bump, migration, ledger, manager/controller layer, UI/Unity authority, social-class engine, mobility engine, route-history model, or `PersonRegistry` domain expansion.
