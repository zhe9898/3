...
- current player-command, governance/office, family, force/campaign, warfare, court-policy, regime, social-mobility, personnel-flow, social-position, and household-mobility ViewModels may carry projected leverage, cost, readback, SocialMemory residue, home-household local response, v19-v492 owner-lane readback/preflight/closeout fields, Office/Family/Force/Warfare/Court process fields, directive-choice readbacks, aftermath docket readbacks, policy local-response, memory-pressure, public-reading echo, public follow-up cue, docket guard, suggested-action guard, suggested-receipt guard, receipt-docket consistency guard, public-life receipt echo guard, fidelity-scale/mobility/influence readbacks, regime-legitimacy readback, personnel-flow readiness, owner-lane gate, future-lane preflight wording, `SocialPositionReadbackSummary`, `SocialPositionSourceModuleKeys`, `SocialPositionScaleBudgetReadbackSummary`, and `HouseholdMobilityDynamicsSummary`; Unity shell code copies those fields only and must not query simulation modules directly or calculate owner-lane return guidance
- current v35-v492 canal-window, Family, Office/yamen, Force/Campaign, Warfare, Court-policy, social mobility, regime, personnel-flow, social-position, and household-mobility readback/preflight/closeout is still outside Unity authority: Unity may bind projected route/market/order/family/office/force/campaign/aftermath/court-policy/fidelity/mobility/regime/preflight/social-position/household-mobility fields, but must not calculate canal exposure, sponsor targeting, affected settlements, Office closure, relief success, military outcomes, court-policy outcomes, SocialMemory residue meaning, public-reading echo, public follow-up cue, docket guard, suggested-action priority, suggested receipt meaning, receipt-docket consistency, public-life receipt echo, social-mobility tier, regime legitimacy, personnel-flow target eligibility, social class/status ranking, household movement, route history, future household mobility eligibility, preflight closeout authority, module event consumers, or command availability from event metadata
...
- Unity assembly definitions should reinforce host-shell boundaries and reduce recompilation scope; Unity code may optimize binding, pooling, canvases, and assets, but must not become a simulation dependency root
- treat `GC.Alloc`, canvas rebuilds, per-frame LINQ, reflection, and repeated ViewModel reconstruction as evidence triggers for profiling before and after a shell optimization
...
- work touches `unity/Zongzu.UnityShell`, Unity scenes, prefabs, assets, `.meta` files, MonoBehaviours, bindings, or play/editor validation
- work touches `src/Zongzu.Presentation.Unity`, `src/Zongzu.Presentation.Unity.ViewModels`, or Unity presentation tests
- a shell implementation needs pooling, canvas/layer structure, Addressables/assets, memory, frame, or profiler guidance
- a Unity surface must prove it copies projected fields without owning rules
- generated assets or Unity-facing labels need provenance and presentation-only boundaries

## Fast Lane

For pure ViewModel/adapter copy changes, run the relevant presentation tests and do not require Unity editor validation. Use a full Unity pass when scenes, prefabs, assets, MonoBehaviours, frame behavior, pooling, Addressables, or screenshots/play-mode checks are touched.
...
5. Keep authority out of Unity.
   ...
   - shows public-life/order refusal, response, residue, follow-up, owner-lane return, `承接入口`, `归口状态`, `归口后读法`, Office/Family/Force/Warfare/Court lane readback, directive-choice readback, aftermath docket readback, policy local-response, memory-pressure, public-reading echo, public follow-up cue, docket guard, suggested-action guard, suggested-receipt guard, receipt-docket consistency guard, public-life receipt echo guard, fidelity-scale / mobility / influence readbacks, regime-legitimacy readback, personnel-flow readiness, owner-lane gate, or future-lane preflight wording only when it is already present in projected command receipts, governance lanes, household pressure, owner-lane surfaces, Office/Family/Force/Warfare/Court surfaces, SocialMemory read models, or population/person/regime read models
