...
- current player-command, governance/office, family, force/campaign, warfare, and court-policy ViewModels may carry projected leverage, cost, readback, SocialMemory residue, home-household local response, v19-v148 owner-lane readback fields, Office/Family/Force/Warfare/Court process fields, directive-choice readbacks, aftermath docket readbacks, policy local-response, memory-pressure, and public-reading echo; Unity shell code copies those fields only and must not query simulation modules directly or calculate owner-lane return guidance
- current v35-v148 canal-window, Family, Office/yamen, Force/Campaign, Warfare, and Court-policy readback is still outside Unity authority: Unity may bind projected route/market/order/family/office/force/campaign/aftermath/court-policy fields, but must not calculate canal exposure, sponsor targeting, affected settlements, Office closure, relief success, military outcomes, court-policy outcomes, SocialMemory residue meaning, public-reading echo, module event consumers, or command availability from event metadata
