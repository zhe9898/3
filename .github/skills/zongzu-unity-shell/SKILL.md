...
5. Keep authority out of Unity.
   ...
   - shows public-life/order refusal, response, residue, follow-up, owner-lane return, `承接入口`, `归口状态`, `归口后读法`, Office/Family/Force/Warfare/Court lane readback, directive-choice readback, or aftermath docket readback only when it is already present in projected command receipts, governance lanes, household pressure, owner-lane surfaces, Office/Family/Force/Warfare/Court surfaces, or SocialMemory read models
