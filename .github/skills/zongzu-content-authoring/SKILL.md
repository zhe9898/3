...
- Do not infer accepted, partial, refused, repeated, switched, cooled-down, Office-closed, Family-guaranteed, relief-granted, military, aftermath, court-policy, public-reading, or memory-pressure outcomes from prose; use structured owner-module trace fields, household snapshots, jurisdiction snapshots, FamilyCore snapshots, WarfareCampaign snapshots, Office/PublicLife snapshots, and SocialMemory read models.
