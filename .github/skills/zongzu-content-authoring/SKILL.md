...
- Do not infer accepted, partial, refused, repeated, switched, cooled-down, Office-closed, Family-guaranteed, relief-granted, military, aftermath, court-policy, public-reading, memory-pressure, regime-legitimacy, social-mobility, influence, fidelity-scale, personnel-flow readiness, owner-lane gates, future-lane preflight, or personnel-command outcomes from prose; use structured owner-module trace fields, household snapshots, jurisdiction snapshots, FamilyCore snapshots, WarfareCampaign snapshots, Office/PublicLife snapshots, Population/PersonRegistry snapshots, and SocialMemory read models.
