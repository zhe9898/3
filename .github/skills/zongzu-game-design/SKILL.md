...
- the current mainline is committed through v300: v3-v108 build and audit the thin skeleton; v109-v204 closes the first court-policy rule-density branch without making a full court engine; v213-v292 adds and closes the first social mobility / fidelity-ring substrate; v253-v268 closes Chain 9 regime-legitimacy first readback; v293-v300 adds personnel-command preflight guardrails without adding direct move/transfer/summon commands
- current v19-v300 follow-up, owner-lane, court-policy, mobility, regime, and personnel-preflight readbacks are playable guidance, not new household omnipotence or player-as-god control: they advise repeat, switch, cool down, return to the proper owner lane, explain docket/receipt anti-misread, explain fidelity/detail scale, or stop re-pressuring local surfaces from existing structured aftermath
- treat public-life/order/court-policy/regime/social-mobility/personnel-preflight v18-v300 as rule-driven command / aftermath / SocialMemory / home-household / owner-lane / docket / receipt / mobility-scale readback, not an event-chain, event pool, full court engine, full regime engine, full society engine, or direct personnel-control design
...
- v101-v108 is an audit boundary: "thin-chain complete" means topology/readback/ownership evidence; v109-v204 is the first court-policy rule-density branch; v213-v292 is the first mobility/personnel-flow substrate; v253-v268 is first-layer regime readback; v293-v300 is only a personnel-command preflight. Taxes, famine, disaster relief, office factions, thick court process, campaign logistics, full regime recognition, canal politics, deeper durable residue, migration economy, direct personnel commands, and recovery/decay remain future work
