...
- v101-v108 is an audit boundary: "thin-chain complete" means topology/readback/ownership evidence; v109-v204 is the first court-policy rule-density branch; v213-v292 is the first mobility/personnel-flow substrate; v253-v268 is first-layer regime readback; v293-v380 is only personnel-flow readiness/gate/future-lane preflight and closeout evidence; v381-v452 is social-position and scale-budget readback/preflight evidence; v453-v460 is household mobility dynamics explanation over existing signals; v461-v468 is closeout governance, not runtime depth. Taxes, famine, disaster relief, office factions, thick court process, campaign logistics, full regime recognition, canal politics, deeper durable residue, migration economy, direct personnel commands, Family/Office/Warfare personnel-flow owner lanes, commoner status formulas, social-class mobility engines, and recovery/decay remain future work
