...
- v35-v492 use structured metadata/query snapshots, existing owner state, projection-only readbacks, or docs/tests preflight evidence only: canal-window Trade/Order, household-family sponsor pressure, Family relief, Office policy implementation/readback, Office/Family lane closure, Force/Campaign owner-lane readback, Warfare directive/aftermath readback, Court-policy readback/guards, social mobility fidelity-ring/pool readbacks, regime-legitimacy readback, personnel-flow readiness/gate/future-lane preflight, commoner/social-position readback/source keys/scale-budget summaries, household mobility dynamics explanation/closeout/preflight/preflight-closeout, and closeout/preflight audits add no schema, migration, ledger, household target field, social-class engine, `PersonRegistry` domain expansion, or UI/Unity authority unless a future rule-density pass explicitly plans it
...
- For public-life/order/court-policy/regime/social-mobility/personnel-flow/social-position/household-mobility work, preserve the current v492 split: each owning module resolves its own command/traces, SocialMemory owns durable social residue on its later cadence, PopulationAndHouseholds owns household livelihood/activity/pools and household mobility dynamics plus the default first future owner lane for household mobility depth, PersonRegistry owns identity plus existing `FidelityRing` only, Office/PublicLife own court-policy/regime local readback, and Application/Unity copy projections only. v19-v492 readback/preflight fields, including `SocialPositionReadbackSummary`, `SocialPositionSourceModuleKeys`, `SocialPositionScaleBudgetReadbackSummary`, and `MobilityDynamicsExplanationSummary`, do not become cooldown ledgers, owner-lane ledgers, follow-up/docket/suggested-action/receipt/receipt-docket/public-life-receipt/mobility/personnel/future-lane/status/route-history/preflight-closeout ledgers, command resolvers, ranking rules, movement commands, or rule layers.
