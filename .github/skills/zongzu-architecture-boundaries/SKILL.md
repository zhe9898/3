...
- current mainline is implemented through v460: v109-v204 closes the first Chain 8 court-policy rule-density branch; v213-v292 implements and closes the first social mobility / fidelity-ring substrate and influence readback; v253-v268 closes Chain 9 regime-legitimacy first readback; v293-v380 closes personnel-flow command-readiness, owner-lane gate, desk echo, containment, and future Family/Office/Warfare preflight visibility without adding direct movement lanes; v381-v452 closes commoner/social-position readback, owner-source keys, scale-budget readback, regional guard, commoner status owner-lane preflight, and fidelity scale-budget preflight; v453-v460 adds household mobility dynamics explanation as runtime projection over existing household signals
...
- topology or feature-pack growth must declare node/edge owners, event metadata, fanout caps, dormant/future-contract status, manifest/save membership, and startup/load cost; Zongzu supports additive manifest-gated feature packs, not unsafe runtime plugin marketplaces.
...
- For public-life/order/court-policy/regime/social-mobility/personnel-flow/social-position/household-mobility work, preserve the current v460 split: each owning module resolves its own command/traces, SocialMemory owns durable social residue on its later cadence, PopulationAndHouseholds owns household livelihood/activity/pools and household mobility dynamics, PersonRegistry owns identity plus existing `FidelityRing` only, Office/PublicLife own court-policy/regime local readback, and Application/Unity copy projections only. v19-v460 readback fields, including `SocialPositionReadbackSummary`, `SocialPositionSourceModuleKeys`, `SocialPositionScaleBudgetReadbackSummary`, and `MobilityDynamicsExplanationSummary`, do not become cooldown ledgers, owner-lane ledgers, follow-up/docket/suggested-action/receipt/receipt-docket/public-life-receipt/mobility/personnel/future-lane/status ledgers, command resolvers, ranking rules, movement commands, or rule layers.
