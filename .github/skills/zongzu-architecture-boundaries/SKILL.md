...
- current mainline is implemented through v468: v109-v204 closes the first Chain 8 court-policy rule-density branch; v213-v292 implements and closes the first social mobility / fidelity-ring substrate and influence readback; v253-v268 closes Chain 9 regime-legitimacy first readback; v293-v380 closes personnel-flow command-readiness, owner-lane gate, desk echo, containment, and future Family/Office/Warfare preflight visibility without adding direct movement lanes; v381-v452 closes commoner/social-position readback, owner-source keys, scale-budget readback, regional guard, commoner status owner-lane preflight, and fidelity scale-budget preflight; v453-v460 adds household mobility dynamics explanation as runtime projection over existing household signals; v461-v468 closes that layer as governance evidence only
...
- v35-v468 use structured metadata/query snapshots and existing owner state or projection-only readbacks only: canal-window Trade/Order, household-family sponsor pressure, Family relief, Office policy implementation/readback, Office/Family lane closure, Force/Campaign owner-lane readback, Warfare directive/aftermath readback, Court-policy readback/guards, social mobility fidelity-ring/pool readbacks, regime-legitimacy readback, personnel-flow readiness/gate/future-lane preflight, commoner/social-position readback/source keys/scale-budget summaries, household mobility dynamics explanation/closeout, and closeout audits add no schema, migration, ledger, household target field, social-class engine, `PersonRegistry` domain expansion, or UI/Unity authority unless a future rule-density pass explicitly plans it
...
- For public-life/order/court-policy/regime/social-mobility/personnel-flow/social-position/household-mobility work, preserve the current v468 split: each owning module resolves its own command/traces, SocialMemory owns durable social residue on its later cadence, PopulationAndHouseholds owns household livelihood/activity/pools and household mobility dynamics, PersonRegistry owns identity plus existing `FidelityRing` only, Office/PublicLife own court-policy/regime local readback, and Application/Unity copy projections only. v19-v468 readback fields, including `SocialPositionReadbackSummary`, `SocialPositionSourceModuleKeys`, `SocialPositionScaleBudgetReadbackSummary`, and `MobilityDynamicsExplanationSummary`, do not become cooldown ledgers, owner-lane ledgers, follow-up/docket/suggested-action/receipt/receipt-docket/public-life-receipt/mobility/personnel/future-lane/status/route-history ledgers, command resolvers, ranking rules, movement commands, or rule layers.
