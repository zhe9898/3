...
public static class FamilyCoreEventNames
{
    ...
    /// <para>Exam-pass adjustments carry structured metadata such as cause,
    /// source event, person id, credential tier, score, prestige delta, marriage
    /// delta, and profile dimensions. Other causes should add equivalent metadata
    /// before downstream consumers depend on them.</para>
    /// </summary>
